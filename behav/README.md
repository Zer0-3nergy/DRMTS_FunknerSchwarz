...
- **`decimation_filters.m`**  
  Simple script that visualizes the designed filters used throughout the decimation stage using the FVTool in Matlab.  
  The file is not used further. <br>
