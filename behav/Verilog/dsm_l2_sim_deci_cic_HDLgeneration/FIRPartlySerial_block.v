...
module FIRPartlySerial_block
  ...
  input   ctrl;
  output  signed [67:0] subfilterOutTmp_2;  // sfix68_En63
  ...
  wire coeffNonZero;
  wire signed [67:0] gainOut;  // sfix68_En63
  ...
  wire signed [67:0] gainOut_1;  // sfix68_En63
  reg signed [67:0] gainOutDB;  // sfix68_En63
  wire signed [67:0] gainOutSwitch;  // sfix68_En63
  reg signed [67:0] filterDelay_reg [0:3];  // sfix68 [4]
  reg signed [67:0] filterDelay_reg_next [0:3];  // sfix68_En63 [4]
  reg signed [67:0] gainOutREG;  // sfix68_En63
  ...
  assign coeffNonZero = coeffTableReg3_1 != 34'sh000000000;

  assign gainOut = 68'sh00000000000000000;
  ...
  assign gainOut_1 = {{2{delayLineDataOut3[33]}}, {delayLineDataOut3, 32'b00000000000000000000000000000000}};

  always @(posedge clk or posedge reset)
    begin : filterDelay_process
      if (reset == 1'b1) begin
        gainOutDB <= 68'sh00000000000000000;
      end
      else begin
        if (enb) begin
          gainOutDB <= gainOut_1;
    ...
    begin : filterDelay_1_process
      if (reset == 1'b1) begin
        for(filterDelay_t_1 = 32'sd0; filterDelay_t_1 <= 32'sd3; filterDelay_t_1 = filterDelay_t_1 + 32'sd1) begin
          filterDelay_reg[filterDelay_t_1] <= 68'sh00000000000000000;
        end
      end
      else begin
        if (enb) begin
  ...
  assign sumOut_2 = gainOutREG[66:0];
