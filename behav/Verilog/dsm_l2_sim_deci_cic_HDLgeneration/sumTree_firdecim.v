...
module sumTree_firdecim
  ...
  input   reset;
  input   enb;
  input   signed [67:0] accIn_0;  // sfix68_En63
  input   signed [67:0] accIn_1;  // sfix68_En63
  input   subfilterOut_vld2;
  output  signed [65:0] accOut;  // sfix66_En62
  output  accOutVld;


  wire signed [67:0] accS_1;  // sfix68_En63
  reg signed [67:0] accReg_1;  // sfix68_En63
  wire signed [65:0] dout_cast;  // sfix66_En62
  reg signed [65:0] accOut_1;  // sfix66_En62
  ...
  always @(posedge clk or posedge reset)
    begin : intdelay_process
      if (reset == 1'b1) begin
        accReg_1 <= 68'sh00000000000000000;
      end
      else begin
        if (enb) begin
          accReg_1 <= accS_1;
  ...
  assign dout_cast = accReg_1[66:1];

  always @(posedge clk or posedge reset)
    begin : intdelay_1_process
      if (reset == 1'b1) begin
        accOut_1 <= 66'sh00000000000000000;
      end
      else begin
        if (enb) begin
          accOut_1 <= dout_cast;
