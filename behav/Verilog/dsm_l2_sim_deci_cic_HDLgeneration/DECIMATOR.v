...
module DECIMATOR
  ...
  input   In2;
  output  ce_out;
  output  signed [131:0] Out2;  // sfix132_En127
  output  Out1;


  wire signed [15:0] CIC_Decimator_out1;  // sfix16_En14
  wire CIC_Decimator_out2;
  wire signed [32:0] DCF_out1;  // sfix33_En30
  wire DCF_out2;
  wire signed [65:0] HBF1_out1;  // sfix66_En62
  wire HBF1_out2;
  wire signed [131:0] HBF2_out1;  // sfix132_En127
  wire HBF2_out2;
