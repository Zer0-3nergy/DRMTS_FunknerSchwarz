...
module FirRdyLogic
  ...
  input   reset;
  input   enb;
  input   signed [33:0] dinSwitch;  // sfix34_En30
  input   dinVldSwitch;
  input   signed [33:0] coeff;  // sfix34_En30
  input   haltProcess;
  output  signed [33:0] dinSM;  // sfix34_En30
  output  dinVldSM;
  ...
  reg  readySM;
  reg signed [33:0] dinSM_1;  // sfix34_En30
  reg  dinVldSM_1;
  reg signed [33:0] coeffS;  // sfix34_En30
  reg  firRdy_out2_0;
      ...
      case ( firRdy_state)
        ...
        1'b1 :
          begin
            firRdy_readyReg_next = 1'b1;
            firRdy_state_next = 1'b0;
            dinSM_1 = 34'sh000000000;
            coeffS = 34'sh000000000;
            firRdy_out2_0 = 1'b0;
          end
        default :
          begin
