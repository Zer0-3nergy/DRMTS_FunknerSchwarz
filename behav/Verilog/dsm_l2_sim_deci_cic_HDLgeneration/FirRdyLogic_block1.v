...
module FirRdyLogic_block1
  ...
  input   reset;
  input   enb;
  input   signed [66:0] dinSwitch;  // sfix67_En62
  input   dinVldSwitch;
  input   signed [66:0] coeff;  // sfix67_En62
  input   haltProcess;
  output  signed [66:0] dinSM;  // sfix67_En62
  output  dinVldSM;
  ...
  reg  readySM;
  reg signed [66:0] dinSM_1;  // sfix67_En62
  reg  dinVldSM_1;
  reg signed [66:0] coeffS;  // sfix67_En62
  reg  firRdy_out2_0;
      ...
      case ( firRdy_state)
        ...
        1'b1 :
          begin
            firRdy_readyReg_next = 1'b1;
            firRdy_state_next = 1'b0;
            dinSM_1 = 67'sh00000000000000000;
            coeffS = 67'sh00000000000000000;
            firRdy_out2_0 = 1'b0;
          end
        default :
          begin
