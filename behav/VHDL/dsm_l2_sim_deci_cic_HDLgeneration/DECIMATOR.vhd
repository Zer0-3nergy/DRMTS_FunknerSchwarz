...
ENTITY DECIMATOR IS
  PORT( clk                               :   IN    std_logic;
        ...
        Out2                              :   OUT   std_logic_vector(131 DOWNTO 0);  -- sfix132_En127
        Out1                              :   OUT   std_logic
        );
END DECIMATOR;
...
ARCHITECTURE rtl OF DECIMATOR IS
  ...
  COMPONENT DCF
    PORT( clk                             :   IN    std_logic;
          ...
          validIn                         :   IN    std_logic;
          dataOut                         :   OUT   std_logic_vector(32 DOWNTO 0);  -- sfix33_En30
          validOut                        :   OUT   std_logic
          );
  END COMPONENT;
  ...
  SIGNAL DCF_out1                         : std_logic_vector(32 DOWNTO 0);  -- ufix33
  SIGNAL DCF_out2                         : std_logic;
  SIGNAL HBF1_out1                        : std_logic_vector(65 DOWNTO 0);  -- ufix66
  SIGNAL HBF1_out2                        : std_logic;
  SIGNAL HBF2_out1                        : std_logic_vector(131 DOWNTO 0);  -- ufix132
...
BEGIN
  ...
  u_HBF1 : HBF1
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              dataIn => DCF_out1,  -- sfix33_En30
              validIn => DCF_out2,
              dataOut => HBF1_out1,  -- sfix66_En62
              validOut => HBF1_out2
              );
  ...
  u_HBF2 : HBF2
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              dataIn => HBF1_out1,  -- sfix66_En62
              validIn => HBF1_out2,
              dataOut => HBF2_out1,  -- sfix132_En127
              validOut => HBF2_out2
              );
