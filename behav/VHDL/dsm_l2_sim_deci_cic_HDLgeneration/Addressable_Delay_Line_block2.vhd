...
ARCHITECTURE rtl OF Addressable_Delay_Line_block2 IS
  ...
  -- Signals
  SIGNAL dataIn_signed                    : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL delayedSignals0                  : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL delayedSignals1                  : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL switchDataOut                    : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL dataOut_tmp                      : signed(33 DOWNTO 0);  -- sfix34_En30
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      delayedSignals0 <= to_signed(0, 34);
  ...
  BEGIN
    IF reset = '1' THEN
      delayedSignals1 <= to_signed(0, 34);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' AND validIn = '1' THEN
