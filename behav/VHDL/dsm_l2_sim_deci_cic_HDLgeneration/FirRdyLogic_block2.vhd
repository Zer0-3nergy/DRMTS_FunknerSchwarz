...
ARCHITECTURE rtl OF FirRdyLogic_block2 IS
  ...
  -- Signals
  SIGNAL dinSwitch_signed                 : signed(66 DOWNTO 0);  -- sfix67_En62
  SIGNAL coeff_signed                     : signed(66 DOWNTO 0);  -- sfix67_En62
  ...
  SIGNAL dinSM_tmp                        : signed(66 DOWNTO 0);  -- sfix67_En62
  SIGNAL coeffS                           : signed(66 DOWNTO 0);  -- sfix67_En62
    ...
    IF (( NOT haltProcess) AND ( NOT syncReset)) = '1' THEN 
      CASE firRdy_state IS
        ...
        WHEN '1' =>
          firRdy_readyReg_next <= '1';
          firRdy_state_next <= '0';
          dinSM_tmp <= to_signed(0, 67);
          coeffS <= to_signed(0, 67);
          out2 := '0';
        WHEN OTHERS => 
          dinSM_tmp <= to_signed(0, 67);
          out2 := '0';
