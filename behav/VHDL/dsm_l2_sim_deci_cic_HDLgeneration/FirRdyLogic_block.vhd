...
ARCHITECTURE rtl OF FirRdyLogic_block IS
  ...
  -- Signals
  SIGNAL dinSwitch_signed                 : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL coeff_signed                     : signed(33 DOWNTO 0);  -- sfix34_En30
  ...
  SIGNAL dinSM_tmp                        : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL coeffS                           : signed(33 DOWNTO 0);  -- sfix34_En30
    ...
    IF (( NOT haltProcess) AND ( NOT syncReset)) = '1' THEN 
      CASE firRdy_state IS
        ...
        WHEN '1' =>
          firRdy_readyReg_next <= '1';
          firRdy_state_next <= '0';
          dinSM_tmp <= to_signed(0, 34);
          coeffS <= to_signed(0, 34);
          out2 := '0';
        WHEN OTHERS => 
          dinSM_tmp <= to_signed(0, 34);
          out2 := '0';
