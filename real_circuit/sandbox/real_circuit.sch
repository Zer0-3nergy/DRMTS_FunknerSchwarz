...
.endc
"}
C {vsource.sym} 260 570 0 0 {name=Vphi1 value="PULSE(0V 3V 0 1n 1n 490n 1u)" savecurrent=false}
C {gnd.sym} 260 600 0 0 {name=l6 lab=GND}
C {lab_pin.sym} 260 540 1 0 {name=p7 sig_type=std_logic lab=phi1}
...
C {lab_pin.sym} -20 150 3 0 {name=p21 sig_type=std_logic lab=Vcm}
...
C {/foss/designs/ideal/ideal_opamp.sym} 130 110 0 0 {name=x2}
C {/foss/designs/ideal/ideal_opamp.sym} -840 110 0 0 {name=x3}
...
C {lab_pin.sym} -990 150 3 0 {name=p54 sig_type=std_logic lab=Vcm}
