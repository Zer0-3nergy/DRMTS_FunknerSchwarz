...
C {lab_pin.sym} -20 80 0 0 {name=p21 sig_type=std_logic lab=Vcm}
...
C {/foss/designs/real/simple_OTA.sym} 130 100 0 0 {name=x2}
C {lab_pin.sym} 280 80 1 0 {name=p5 sig_type=std_logic lab=Vdd}
C {gnd.sym} 280 120 0 0 {name=l2 lab=GND}
C {lab_pin.sym} -990 80 0 0 {name=p9 sig_type=std_logic lab=Vcm}
C {/foss/designs/real/simple_OTA.sym} -840 100 0 0 {name=x3}
C {lab_pin.sym} -690 80 1 0 {name=p36 sig_type=std_logic lab=Vdd}
C {gnd.sym} -690 120 0 0 {name=l26 lab=GND}
